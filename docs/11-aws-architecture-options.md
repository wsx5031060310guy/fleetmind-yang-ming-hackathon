...
> 【Day3 07:30–11:00 場外】bug 修 + demo 資料凍結快照 + demo 船 AI 簡報預產快取 + 最終版 FUEL_CONSUMP 提交檔 + slides 換真截圖 + 錄影 + 彩排。【11:30–14:30 現場】11:30 feature/部署凍結，12:00 起上傳全部交付物（不等 14:30 死線），Sunny 核對官方七項提交物，13:30 二次計時彩排。
...
> 【Day3 07:30–11:00 場外】資料凍結快照 → demo 船簡報預產快取 → 錄影 → 彩排。【11:30–14:30 現場】feature freeze；12:00–14:00 上傳官方七項提交物（不等死線）；demo 前 5 分鐘跑 warm-up 腳本把 api-fn/brief-fn 各打一輪（SnapStart 下保險性質）。平行原則：core-calc（Chen）/harness（Feng）/api-fn（Eddie）/infra+Amplify（Sunny）四條線只靠「Day1 上午凍結的 API contract + Speed Loss JSON schema」耦合，互不阻塞。

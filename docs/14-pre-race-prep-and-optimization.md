...
團隊 4 人都有正職，賽前只求把「一定要有、且不依賴真實資料/帳號」的東西先備好。
...
| # | 項目 | 內容 | Owner | 工時 |
| --- | --- | --- | --- | --- |
| PR-6 | **Q&A 15 題演練稿** | `07-judge-qna.md` 從 7 題擴到 15 題，含五大海事追問（基準怎麼定／slow steaming 分離／該不該花 4 萬清／SOG 黑潮／歸因 68% 憑什麼），指定一人專答技術題並口頭演練一次 | 全員 | 3h |
...
P1 小計 ≈ 7h（P0+P1 = 23h，略超 20h 預算，PR-6/PR-7 可視情況壓到 Day1 晚）。

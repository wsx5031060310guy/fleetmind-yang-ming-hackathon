...
| R3 | Day3 提交**七項** checklist（**P5 owner**，逐項對官方清單） | ⚠️ G1/G4/G5 | 「live demo 連結」「企業資料應用說明」「challenge link」三個缺口見 §3 |
...
- `09` §7 Day3 的「五件套」全部改稱「**官方七項提交物**」，P5 的核對清單逐項列出：deck／challenge link／企業資料應用說明／技術架構／GitHub repo／live demo 連結／錄影。
